  ...
  return (
    <div className="w-full h-screen flex justify-center items-center bg-[#F2F2F2]">
      <div className="space-y-6 bg-[#FDFDFD] drop-shadow-lg py-10 px-8 rounded-2xl">
        <h1 className="font-bold text-center text-2xl text-[#242424]">Sign-up</h1>
        ...
        <button className="flex w-full cursor-pointer items-center gap-2.5 justify-center px-12 py-2.5 rounded-lg border-1 border-[#E3E3E3]">
