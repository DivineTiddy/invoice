...
const HomeDesktopNav = () => {
  return (
    <nav className=" flex items-center justify-between w-full bg-[#F9FFFD] md:bg-transparent px-6 py-3.5 border-[#F4F4F4] border-[1px] rounded-[32px] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.25)]">
      ...
      <div className="flex items-center gap-8">
        <p className="cursor-pointer text-[#444444] font-semibold text-lg">
          Login
        </p>
        <Image
